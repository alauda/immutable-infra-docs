...
| Completion | The installer marks the request as `Success` and writes the final cluster state into `ClusterModule/global`. | Installer progress API; `kubectl get clustermodule global` |
