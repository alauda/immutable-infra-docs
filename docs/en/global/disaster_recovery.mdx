...
This table is the DR-specific, split-identity form of the standard Bare Metal registration paths. For the stage-by-stage network requirements that apply to every Bare Metal delivery, DR or not, see [Network Connectivity](../create-cluster/bare-metal.mdx#network-connectivity).
