...
- The VM template contains the required locally preloaded etcd and kube-apiserver image references. Their static-Pod deployment does not remove the image requirement.
