...
- **[Control Plane Endpoint](../how-to/control-plane-endpoint.mdx)** - Confirm the provider/version boundary and prepare either the required external LoadBalancer or a supported Self-built VIP mode
