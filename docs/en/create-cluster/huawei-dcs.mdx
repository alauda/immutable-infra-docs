...
Decide which registry this cluster pulls platform images from — CoreDNS, kube-proxy, and Kube-OVN during bootstrap, and every platform component installed afterwards.
