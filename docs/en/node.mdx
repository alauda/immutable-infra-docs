...
1. **Identify the Unhealthy Machine**
...
2. **Annotate the Machine for Deletion**
...
3. **Wait for Machine Replacement**
...
If you only annotate a machine for deletion without changing the replica count, the MachineDeployment automatically creates a replacement machine to maintain the desired state.
:::
