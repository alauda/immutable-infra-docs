...
| `VSphereMachineConfigPool` | Pool of pre-defined node slots with hostnames, static IPs, and per-slot persistent and ephemeral data disks | [VSphereMachineConfigPool](./vspheremachineconfigpool.mdx) |
