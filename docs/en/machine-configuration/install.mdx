...
Upload the downloaded package to <Term name="product" textCase="capitalize" />. For the detailed upload procedure, refer to <ExternalSiteLink name="acp" href="/extend/upload_package.html#upload-packages" children="Upload Packages" />.
