...
- [Troubleshoot a Workload Cluster Stuck in Provisioned](./troubleshoot-cluster-not-ready.mdx) — diagnose the kubeadm-init-stalled symptom that appears when an unfixed controller boots a dotted-hostname node.
