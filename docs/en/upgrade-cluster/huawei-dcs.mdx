...
2. **Modify the template specifications**
   ...
   - Update `spec.template.spec.dcsMachineCpuSpec.quantity`
   - Update `spec.template.spec.dcsMachineMemorySpec.quantity`
   - Update `spec.template.spec.dcsMachineDiskSpec`
